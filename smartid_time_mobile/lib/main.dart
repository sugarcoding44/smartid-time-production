...
void main() async {
  ...
  runApp(const SmartIdTimeApp());
}

class SmartIdTimeApp extends StatelessWidget {
  const SmartIdTimeApp({super.key});
...
// SmartID TIME Theme - Matching Next.js design system
class SmartIdTheme {
  ...
  static const Color emerald500 = Color(0xFF10b981);  // Added missing emerald500
