...
export const metadata: Metadata = {
  title: 'Support Center | smartID',
  description: 'Get help and support for smartID products and services',
}
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Get the help you need to make the most of your smartID solutions.
            </p>
          </div>
          ...
          <div className="mt-20 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              We're building a comprehensive support center with tutorials, FAQs, and documentation.
            </p>
          </div>
        </div>
      </div>
